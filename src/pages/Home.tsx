...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#EBF7F2] via-[#F5FAF7] to-[#FFF6F0] text-[#143329] px-4 sm:px-8 pt-6 sm:pt-8 pb-32 md:pb-24 selection:bg-[#27B68C] selection:text-white flex flex-col justify-center">
      ...
      >
        ...
        <motion.header variants={itemVariants} className="flex items-center justify-between mb-5 md:mb-8">
          ...
          <div className="flex items-center gap-2">
            {currentStreak > 0 ? (
              ...
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/80 border border-[#D5EFE3] text-[#27B68C] text-xs font-bold shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 items-start">
          ...
          <div className="md:col-span-6 flex flex-col space-y-5 sm:space-y-6">
            ...
            <motion.div variants={itemVariants} className="pt-1 flex flex-col gap-3">
              ...
              <div className="grid grid-cols-3 gap-2 text-center pt-1">
                <div className="flex items-center justify-center gap-1 text-[11px] font-semibold text-[#5B7B70]">
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-2 sm:gap-3 rounded-[28px] bg-white/90 backdrop-blur-xl p-4 sm:p-5 border border-white/90 shadow-[0_10px_30px_rgba(20,55,42,0.04)]"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <span className="text-xs sm:text-sm font-black text-[#143329] mt-0.5 truncate max-w-[95px]">
              ...
              <div className="flex flex-col items-center text-center border-x border-[#E9F3EE]">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#7E9990]">Current Streak</span>
          ...
          <div className="md:col-span-6 flex flex-col space-y-4">
            ...
            <motion.div
              variants={itemVariants}
              className="relative overflow-hidden rounded-[32px] bg-white p-4 sm:p-6 border border-white/90 shadow-[0_16px_40px_rgba(20,55,42,0.06)]"
            >
              <div className="relative w-full h-48 sm:h-56 md:h-64 rounded-[22px] overflow-hidden bg-[#D8EFE5] shadow-inner flex items-center justify-center">
                <img
                  src="/hero-mint.jpg"
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#143329]/60 via-[#143329]/20 to-transparent" />
              ...
              <div className="mt-4 pt-3 border-t border-[#EEF6F2]">
                <div className="flex items-center justify-between mb-2.5">
                  <span className="text-xs font-black text-[#143329] uppercase tracking-wider flex items-center gap-1.5">
                    <Info className="w-3.5 h-3.5 text-[#27B68C]" />
                    Today's 5 Exercises
                  </span>
                  <span className="text-[11px] font-bold text-[#5E7A71]">
                    Tap to preview cues
                  </span>
                </div>
                      ...
                      <div key={ex.name} className="flex flex-col">
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-left transition-all cursor-pointer border ${
                            isSelected 
                              ...
                              : 'bg-[#F6FAF8] hover:bg-[#EEF6F2] border-[#E5EFEA] text-[#344E44]'
                          }`}
                        >
                          <div className="flex items-center gap-2">
                            <span className="w-5 h-5 rounded-full bg-white text-[#27B68C] text-[11px] font-black flex items-center justify-center shadow-2xs border border-[#D7ECE2]">
                              {i + 1}
                            </span>
                            <span className="text-xs font-bold text-[#143329]">
                              {ex.name}
                            </span>
                          </div>

                          <div className="flex items-center gap-2">
                            <span className="text-[11px] font-medium text-[#658277]">
                              {ex.work}s / {ex.rest}s rest
                            </span>
                            <ChevronRight className={`w-3.5 h-3.5 text-[#88A398] transition-transform duration-200 ${isSelected ? 'rotate-90 text-[#27B68C]' : ''}`} />
                          </div>
                        </button>
                        ...
                        <AnimatePresence>
                          {isSelected && (
                            ...
                            >
                              <div className="px-3.5 py-2.5 my-1 rounded-xl bg-white border border-[#D5EFE3] text-xs text-[#48665B] leading-relaxed shadow-2xs flex items-start gap-2">
